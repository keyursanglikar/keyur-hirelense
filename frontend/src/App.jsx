...
const FirmDashboard = React.lazy(() => import('./ca/FirmDashboard'))
const StaffDashboard = React.lazy(() => import('./ca/StaffDashboard'))
const HirelensApp = React.lazy(() => import('@hirelense/App.jsx'))
