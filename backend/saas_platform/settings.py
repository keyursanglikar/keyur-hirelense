...
if cors_origins_env:
    ...
    CORS_ALLOWED_ORIGINS = [
        ...
        'http://127.0.0.1:3000',
        'http://127.0.0.1:5173',
        'https://keyur-hirelense-lwbv.vercel.app',
    ]

# Always include the Vercel frontend URL (guards against missing env var on Render)
_vercel_url = 'https://keyur-hirelense-lwbv.vercel.app'
